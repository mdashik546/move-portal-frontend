        ...
        {subscriptions?.length === 0 ? (
          <div className=" flex items-center justify-center bg-black">
            <div className="text-center max-w-md px-6">
              {/* Icon */}
              <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-white/10 flex items-center justify-center text-5xl backdrop-blur-sm border border-white/10">
                🎬
              </div>
              ...
              <p className="text-sm text-gray-400 mt-3 leading-relaxed">
                You haven’t subscribed to any movies yet. Your content will
                appear here once you start exploring premium movies.
              </p>
            </div>
          </div>
        ) : (
